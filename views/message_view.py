...
🎧 Simply send a link from YouTube Music, and let the music flow! 🎧"""
    ...
    def get_quality_options_keyboard(current_quality):
        ...
        quality_options = ["MP3_128", "MP3_320"]
        buttons = []
    ...
    def format_download_history(downloads):
        ...
        for i, download in enumerate(downloads, 1):
            ...
            if download.title and download.artist:
                ...
                track_info += f"{download.content_type.capitalize()} #{download.yt_id or download.deezer_id}{rating_emoji}"
    ...
    def get_error_message(error_type):
        ...
        error_messages = {
            'invalid_url': "❌ Invalid link. Please provide a valid YouTube Music link.",
