...
def setup_command_routes(user_controller: UserController, playlist_controller: PlayListController):
    ...
    @bot.on_message(filters=lambda m: m.text and m.text.startswith("/start"))
    ...
    @bot.on_message(filters=lambda m: m.text and m.text.startswith("/settings"))
    ...
    @bot.on_message(filters=lambda m: m.text and m.text.startswith("/history"))
    ...
    @bot.on_message(filters=lambda m: m.text and m.text.startswith("/help"))
...
If you have any issues or questions, feel free to contact support."""
    ...
    @bot.on_message(filters=lambda m: m.text and m.text.startswith("/about"))
...
Thank you for using MusicDownloader Bot! 🎧"""
    ...
    @bot.on_message(filters=lambda m: m.text and m.text.startswith("/newplaylist"))
    ...
    @bot.on_message(filters=lambda m: m.text and m.text.startswith("/playlists"))
    ...
    @bot.on_message(filters=lambda m: m.text and m.text.startswith("/recommend"))
